...
$(document).ready(function () {
  console.log("test");
  // console.log(LawAddressCustomerTypeConstant);
  CreateDatatableDotNet.init();
});

$("#callAPI").on("click", function () {
  $.ajax({
    url: "http://10.104.10.243:8088/api/driver/list",
    type: "GET",
    success: function (res) {
      console.log(res.data);
      CreateDatatableDotNet.data(res.data);
    },
  });
});

let CreateDatatableDotNet = (function () {
  let table;
  let currentPage = 0;
