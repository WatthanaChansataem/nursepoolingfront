...
$("#submitRegister").on("click", function () {
  ...
  if (
    ...
    modalEdit
      .find(`.div-input-hospitalCode .custom-select`)
      .addClass(isInvalidClass);
    modalEdit
      .find(`.div-input-hospitalCode .${validationErrorMessageClass}`)
      .html(`กรุณาระบุ`);
  ...
  if (
    ...
    modalEdit
      .find(`.div-input-locationCode .custom-select`)
      .addClass(isInvalidClass);
    modalEdit
      .find(`.div-input-locationCode .${validationErrorMessageClass}`)
      .html(`กรุณาระบุ`);
  ...
  if (
    ...
    modalEdit
      .find(`.div-input-departmentCode .custom-select`)
      .addClass(isInvalidClass);
    modalEdit
      .find(`.div-input-departmentCode .${validationErrorMessageClass}`)
      .html(`กรุณาระบุ`);
