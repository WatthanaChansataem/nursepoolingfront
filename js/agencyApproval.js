...
$("#submit").on("click", function () {
  ...
  $.ajax({
    url: "http://10.104.10.243:8088/api/dutySchedule/approvedutyScheduleByDepartment",
    type: "POST",
    headers: {
      Authorization: "Bearer " + localStorage.getItem("token"),
    },
...
let LoadDutyScheduleForIndividualApproval = function () {
  ...
  $.ajax({
    url: "http://10.104.10.243:8088/api/dutySchedule/searchDutyScheduleForAgencyApproval",
    type: "POST",
    headers: {
      Authorization: "Bearer " + localStorage.getItem("token"),
    },
...
let loadUserDateForApproveModal = function (day, data) {
  ...
  $.ajax({
    url: "http://10.104.10.243:8088/api/dutySchedule/searchDutyScheduleForAgencyApprovalDetail",
    type: "POST",
    headers: {
      Authorization: "Bearer " + localStorage.getItem("token"),
    },
